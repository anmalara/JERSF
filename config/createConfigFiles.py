...
@timeit
def createConfigFiles(processes=["QCDPt15to30", "QCDPt15to30_MB", "DATA_RunF"], JECVersions=["Fall17_17Nov2017_V6"], JetLabels=["AK4CHS"], systematics=["PU", "JEC", "JER"], original_dir = "./submittedJobs/", original_file = "JER2017.xml", isMB = False, test_trigger=False, isThreshold=False):
