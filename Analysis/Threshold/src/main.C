...
int main(int argc,char *argv[]){
	...
	TString run_nr = "BCDEF";
	TString dataname_end = "Fall17_17Nov2017";
	TString outSuf = "";
	...
	if(input_path_!=""){
		...
		input_path  = "/nfs/dust/cms/user/amalara/sframe_all/JER2017_Threshold_DATA/Fall17_17Nov2017_V32/AK8PUPPI/Data_";
	...
	TString weight_path  = "/nfs/dust/cms/user/amalara/"; //used as output path of CalculateMCWeights_TriggerThresholds
	...
	if(inputMC_==TString("")){
		...
		input_path_MC = "/nfs/dust/cms/user/amalara/sframe_all/JER2017_Threshold_QCD/Fall17_17Nov2017_V32/AK8PUPPI/QCD.root";
	...
	outpath_postfix = "/nfs/dust/cms/user/amalara/WorkingArea/UHH2_94X_v2/CMSSW_9_4_1/src/UHH2/JER2017/Analysis/plotsThreshold/AK8PUPPI/";

	std::cout << input_path << std::endl;
	std::cout << outpath_postfix << std::endl;
