...
Bool_t MySelector::Process(Long64_t entry) {
  ...
  std::vector<int> Pt_bins_Central(pt_bins_MB, pt_bins_MB + sizeof(pt_bins_MB)/sizeof(double));
  std::vector<int> Pt_bins_HF(pt_bins_MB_HF, pt_bins_MB_HF + sizeof(pt_bins_MB_HF)/sizeof(double));
