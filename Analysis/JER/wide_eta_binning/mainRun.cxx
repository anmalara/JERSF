...
TString canvName = h1.at(m).at(p)->GetTitle();                                              \
std::cout << "help " << canvName << std::endl;                                              \
TString nameXaxis = h1.at(m).at(p)->GetXaxis()->GetTitle();                                 \
TString nameYaxis = h1.at(m).at(p)->GetYaxis()->GetTitle();                                 \
...
int mainRun( bool data, const char* filename, const char* filename_data, TString lumi, TString label_mc, TString label_data, TString Trigger, double gaustails = 0.985){
  ...
  correctJERwithPLI( JER_uncorrelated_corrected_FE_MC, JER_uncorrelated_corrected_FE_MC_error, widths_FE, widths_FE_error, widths_gen_FE, widths_gen_FE_error, shiftForPLI);
  if( real_data ){
    // correct data with PLI from MC
    correctJERwithPLI( JER_uncorrelated_corrected_FE_data, JER_uncorrelated_corrected_FE_data_error, widths_data_FE, widths_data_FE_error, widths_gen_FE, widths_gen_FE_error, shiftForPLI);
  } else {
    // correct 'data' with own PLI
    correctJERwithPLI( JER_uncorrelated_corrected_FE_data, JER_uncorrelated_corrected_FE_data_error, widths_data_FE, widths_data_FE_error, widths_gen_data_FE, widths_gen_data_FE_error, shiftForPLI);
  }
  ...
  std::vector< std::vector< double > > JER_correlated_corrected_FE_MC, JER_correlated_corrected_FE_data;               //cor = correlated
  std::vector< std::vector< double > > JER_correlated_corrected_FE_MC_error, JER_correlated_corrected_FE_data_error;   //uncor = uncorrected fopr reference region
  ...
  correctJERwithPLI( JER_correlated_corrected_FE_MC, JER_correlated_corrected_FE_MC_error, widths_correlated_FE, widths_correlated_FE_error, widths_correlated_gen_FE, widths_correlated_gen_FE_error, shiftForPLI);
  if( real_data ){
    // correct data with PLI from MC
    correctJERwithPLI( JER_correlated_corrected_FE_data, JER_correlated_corrected_FE_data_error, widths_correlated_data_FE, widths_correlated_data_FE_error, widths_correlated_gen_FE, widths_correlated_gen_FE_error, shiftForPLI);
  } else {
    // correct 'data' with own PLI
    correctJERwithPLI( JER_correlated_corrected_FE_data, JER_correlated_corrected_FE_data_error, widths_correlated_data_FE, widths_correlated_data_FE_error, widths_correlated_gen_data_FE, widths_correlated_gen_data_FE_error, shiftForPLI);
  }
  ...
  correctJERwithPLI015(JER015_uncor_FE_MC, JER015_uncor_FE_MC_error, forward_width, forward_width_error, forward_width_gen, forward_width_gen_error, shiftForPLI);
  if( real_data ){
    // correct data with PLI from MC
    correctJERwithPLI015(JER015_uncor_FE_data, JER015_uncor_FE_data_error, forward_width_data, forward_width_data_error, forward_width_gen, forward_width_gen_error, shiftForPLI);
  } else {
    // correct 'data' with own PLI
    correctJERwithPLI015(JER015_uncor_FE_data, JER015_uncor_FE_data_error, forward_width_data, forward_width_data_error, forward_width_gen_data, forward_width_gen_data_error, shiftForPLI);
  }
  ...
  std::vector< std::vector< double > > JER_uncorrelated_corrected_MC_ptdep, JER_uncorrelated_corrected_data_ptdep;
  std::vector< std::vector< double > > JER_uncorrelated_corrected_MC_ptdep_error, JER_uncorrelated_corrected_data_ptdep_error;

  std::vector< std::vector< double > > JER_uncorrelated_corrected_FE_MC_ptdep, JER_uncorrelated_corrected_FE_data_ptdep;
  std::vector< std::vector< double > > JER_uncorrelated_corrected_FE_MC_ptdep_error, JER_uncorrelated_corrected_FE_data_ptdep_error;

  correctForRef( "mccorrected", JER_uncorrelated_corrected_MC_ptdep, JER_uncorrelated_corrected_MC_ptdep_error, JER_uncorrelated_corrected_MC, JER_uncorrelated_corrected_MC_error, asymmetries_width_pt  );
  correctForRef( "datacorrect", JER_uncorrelated_corrected_data_ptdep, JER_uncorrelated_corrected_data_ptdep_error, JER_uncorrelated_corrected_data, JER_uncorrelated_corrected_data_error, asymmetries_width_data_pt  );

  correctForRef( "mccorrected", JER_uncorrelated_corrected_FE_MC_ptdep, JER_uncorrelated_corrected_FE_MC_ptdep_error, JER_uncorrelated_corrected_FE_MC, JER_uncorrelated_corrected_FE_MC_error, forward_width_pt  );
  correctForRef( "datacorrect", JER_uncorrelated_corrected_FE_data_ptdep, JER_uncorrelated_corrected_FE_data_ptdep_error, JER_uncorrelated_corrected_FE_data, JER_uncorrelated_corrected_FE_data_error, forward_width_data_pt  );
  ...
  std::vector< std::vector< double > > JER_correlated_corrected_MC_ptdep, JER_correlated_corrected_data_ptdep;
  std::vector< std::vector< double > > JER_correlated_corrected_MC_ptdep_error, JER_correlated_corrected_data_ptdep_error;

  std::vector< std::vector< double > > JER_correlated_corrected_FE_MC_ptdep, JER_correlated_corrected_FE_data_ptdep;
  std::vector< std::vector< double > > JER_correlated_corrected_FE_MC_ptdep_error, JER_correlated_corrected_FE_data_ptdep_error;

  correctForRef( "mc_cor_corrected", JER_correlated_corrected_FE_MC_ptdep,   JER_correlated_corrected_FE_MC_ptdep_error,   JER_correlated_corrected_FE_MC,   JER_correlated_corrected_FE_MC_error,   forward_width_pt  );
  correctForRef( "data_cor_correct", JER_correlated_corrected_FE_data_ptdep, JER_correlated_corrected_FE_data_ptdep_error, JER_correlated_corrected_FE_data, JER_correlated_corrected_FE_data_error, forward_width_data_pt  );
  ...
  makeScales( scales_classic,    scales_classic_error,    JER_uncorrelated_corrected_data,          JER_uncorrelated_corrected_data_error,          JER_uncorrelated_corrected_MC,          JER_uncorrelated_corrected_MC_error );
  makeScales( scales_fe,         scales_fe_error,         JER_uncorrelated_corrected_FE_data_ptdep,       JER_uncorrelated_corrected_FE_data_ptdep_error,       JER_uncorrelated_corrected_FE_MC_ptdep,       JER_uncorrelated_corrected_FE_MC_ptdep_error );
  makeScales( scales_fe_control, scales_fe_control_error, JER_uncorrelated_corrected_FE_data, JER_uncorrelated_corrected_FE_data_error, JER_uncorrelated_corrected_FE_MC, JER_uncorrelated_corrected_FE_MC_error );	// uncorrected for reference region width, as a cross check. (i think)

  print2(scales_classic);
  print2(scales_fe);
  print2(scales_fe_control);

  print2(JER_uncorrelated_corrected_data);
  print2(JER_uncorrelated_corrected_FE_data_ptdep);
  print2(JER_uncorrelated_corrected_FE_data);
  ...
  makeScales( scales_cor_classic,    scales_cor_classic_error,    JER_correlated_corrected_data,          JER_correlated_corrected_data_error,          JER_correlated_corrected_MC,          JER_correlated_corrected_MC_error );
  makeScales( scales_cor_fe,         scales_cor_fe_error,         JER_correlated_corrected_FE_data_ptdep,       JER_correlated_corrected_FE_data_ptdep_error,       JER_correlated_corrected_FE_MC_ptdep,       JER_correlated_corrected_FE_MC_ptdep_error );
  makeScales( scales_cor_fe_control, scales_cor_fe_control_error, JER_correlated_corrected_FE_data, JER_correlated_corrected_FE_data_error, JER_correlated_corrected_FE_MC, JER_correlated_corrected_FE_MC_error );	// uncorrected for reference region width, as a cross check. (i think)
  ...
  fill_hist( "MC_JER_classic"  , JER_MC_hist   , JER_uncorrelated_corrected_MC        , JER_uncorrelated_corrected_MC_error        , asymmetries_width_pt     , 0.2);
  fill_hist( "data_JER_classtc", JER_data_hist , JER_uncorrelated_corrected_data      , JER_uncorrelated_corrected_data_error      , asymmetries_width_data_pt, 0.2);
  fill_hist( "SF_classic"      , JER_scale_hist, scales_classic, scales_classic_error, asymmetries_width_data_pt, 3.0);

  fill_hist( "MC_JER_FE", JER_FE_MC_hist, JER_uncorrelated_corrected_FE_MC_ptdep, JER_uncorrelated_corrected_FE_MC_ptdep_error, forward_width_pt, 0.2);
  fill_hist( "MC_JER_FE015", JER015_FE_MC_hist, JER015_FE_MC,   JER015_FE_MC_error, forward_width_pt, 0.2);

  fill_hist( "data_JER_FE", JER_FE_data_hist, JER_uncorrelated_corrected_FE_data_ptdep, JER_uncorrelated_corrected_FE_data_ptdep_error, forward_width_data_pt, 0.2);
  fill_hist( "SF_FE", JER_FE_scale_hist, scales_fe, scales_fe_error, forward_width_data_pt, 3.0);

  fill_hist( "MC_JER_FE_control", JER_FE_MC_hist_control, JER_uncorrelated_corrected_FE_MC, JER_uncorrelated_corrected_FE_MC_error, forward_width_pt, 0.2);
  fill_hist( "data_JER_FE_control", JER_FE_data_hist_control, JER_uncorrelated_corrected_FE_data, JER_uncorrelated_corrected_FE_data_error, forward_width_data_pt, 0.2);
  ...
  fill_hist( "MC_cor_JER_classic",   JER_cor_MC_hist,    JER_correlated_corrected_MC,         JER_correlated_corrected_MC_error,         asymmetries_width_pt, 0.2);
  fill_hist( "data_cor_JER_classtc", JER_cor_data_hist,  JER_correlated_corrected_data,       JER_correlated_corrected_data_error,       asymmetries_width_data_pt, 0.2);
  fill_hist( "SF_cor_classic",       JER_cor_scale_hist, scales_cor_classic, scales_cor_classic_error, asymmetries_width_data_pt, 3.0);

  fill_hist( "MC_cor_JER_FE",   JER_cor_FE_MC_hist,    JER_correlated_corrected_FE_MC_ptdep,   JER_correlated_corrected_FE_MC_ptdep_error,   forward_width_pt, 0.2);
  fill_hist( "data_cor_JER_FE", JER_cor_FE_data_hist,  JER_correlated_corrected_FE_data_ptdep, JER_correlated_corrected_FE_data_ptdep_error, forward_width_data_pt, 0.2);
  fill_hist( "SF_cor_FE",       JER_cor_FE_scale_hist, scales_cor_fe,   scales_cor_fe_error,   forward_width_data_pt, 3.0);

  fill_hist( "MC_cor_JER_FE_control",   JER_cor_FE_MC_hist_control,    JER_correlated_corrected_FE_MC,   JER_correlated_corrected_FE_MC_error,   forward_width_pt, 0.2);
  fill_hist( "data_cor_JER_FE_control", JER_cor_FE_data_hist_control,  JER_correlated_corrected_FE_data, JER_correlated_corrected_FE_data_error, forward_width_data_pt, 0.2);
  fill_hist( "SF_cor_FE_control",       JER_cor_FE_scale_hist_control, scales_cor_fe_control, scales_cor_fe_control_error, forward_width_data_pt, 3.0);
...
for( unsigned int m = 0; m < JER_data_hist.size(); m++ ){
  ...
  JER_data_hist.at(m)->SetStats(kFALSE);
  JER_MC_hist.at(m)->SetStats(kFALSE);
...
for( unsigned int m = 0; m < JER_scale_hist.size(); m++ ){
  PLOT_1(JER_scale_hist,kBlue,m)

  if(JER_scale_hist.at(m)->GetFunction("constfit")) JER_scale_hist.at(m) -> GetFunction("constfit")->SetLineColor(kBlue);
...
for( unsigned int m = 0; m < JER_cor_data_hist.size(); m++ ){ // plot with JERs with NSC fit
  ...
  sprintf(legTitle,     "#eta #in [%.3f,%.3f]", eta_bins_edge[m], eta_bins_edge[m+1]);
  tdrHeader(leg,legTitle);
  leg->AddEntry(JER_cor_data_hist.at(m),"data","lep");
...
for( unsigned int m = 0; m < JER_cor_FE_MC_hist.size(); m++ ){
  ...
  tdrHeader(leg,legTitle);
  leg->AddEntry(JER_cor_FE_data_hist.at(m),"data","lep");
...
for( unsigned int m = 0; m < resolutions.size(); m++ ){
  ...
  TF1 * tempTF1 = new TF1( name_TF1, "TMath::Sqrt([0]*TMath::Abs([0])/(x*x)+[1]*[1]*pow(x,[3])+[2]*[2])",  0, 1500 );
...
for( unsigned int m = 0; m < (JER_MC_Truth_FE.size()-1); m++ ){
  ...
  PLOT_4(JER_MC_Truth_FE,JER_FE_MC_hist,JER_cor_FE_MC_hist,JER015_FE_MC_hist,kRed,kBlue,kMagenta,kGreen+2,m)
  ...
  TLegend *leg = tdrLeg(0.6,0.7,0.9,0.9);
  leg->AddEntry(JER_MC_Truth_FE.at(m+1), "MC Truth", "lep");
...

{
  ...
  PLOT_3_MCT(JER_MC_Truth_FE,JER_FE_MC_hist_control,JER_cor_FE_MC_hist_control,kRed,kBlue,kMagenta,0)
...
for( unsigned int m = 0; m < JER_scale_hist.size(); m++ ){
  ...
  tdrHeader(leg,legTitle);
  leg->AddEntry(JER_scale_hist.at(m),"#sigma_{JER}^{data}/#sigma_{JER}^{MC}","lep");
  leg->AddEntry(JER_cor_scale_hist.at(m),"#sigma_{JER}^{data}/#sigma_{JER}^{MC} corelated","lep");
...
for( unsigned int m = 0; m < JER_FE_scale_hist.size(); m++ ){
  ...
  leg->AddEntry(JER_FE_scale_hist.at(m),"#sigma_{JER}^{data}/#sigma_{JER}^{MC}","lep");
  leg->AddEntry(JER_cor_FE_scale_hist.at(m),"#sigma_{JER}^{data}/#sigma_{JER}^{MC}","lep");
