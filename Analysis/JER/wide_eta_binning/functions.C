...
void histWidthAsym2( std::vector< std::vector< std::vector< TH1F* > > > &Asymmetry , std::vector< std::vector< std::vector< double > > > &Widths, std::vector< std::vector< std::vector< double > > > &WidthsError , bool fill_all, double alpha = 0.985 );
...
void histLinCorFit( std::vector< std::vector< std::vector< double > > > Widths, std::vector< std::vector< std::vector< double > > > WidthsError, std::vector< std::vector< TGraphErrors* > > &output_graph, std::vector< std::vector< double > > &output, std::vector< std::vector< double > > &output_error );
...
void histWidthAsym2( std::vector< std::vector< std::vector< TH1F* > > > &Asymmetry , std::vector< std::vector< std::vector< double > > > &Widths, std::vector< std::vector< std::vector< double > > > &WidthsError , bool fill_all, double alpha){
  double asym;
  double asymerr;
...
void histLinCorFit( std::vector< std::vector< std::vector< double > > > Widths, std::vector< std::vector< std::vector< double > > > WidthsError, std::vector< std::vector< TGraphErrors* > > &output_graph, std::vector< std::vector< double > > &output, std::vector< std::vector< double > > &output_error ){
  for( unsigned int m = 0; m < Widths.size(); m++ ){
    ...
    for( unsigned int p = 0; p < Widths.at(m).size(); p++ ){
      ...
      if (Widths.size() > 10) name_test = "GraphFE_eta";
...
void correctForRef( TString name1, std::vector<std::vector<double> > &Output, std::vector<std::vector<double> > &OutputError, std::vector<std::vector<double> > Input, std::vector<std::vector<double> > InputError, std::vector<std::vector<std::vector<double> > > width_pt  ){
  ...
  for( unsigned int p = 0; p < Input.at(0).size(); p++ ){
    if ( Input.at(0).at(p) != 0 && !(TMath::IsNaN(Input.at(0).at(p)))){
      ...
      hist->SetBinContent(hist->FindBin(pT), Input.at(0).at(p) );
      hist->SetBinError(  hist->FindBin(pT), InputError.at(0).at(p) );
    }
  }
  ...
  for( unsigned int m = 1; m < Input.size() ; m++ ){
    ...
    for( unsigned int p = 0; p < Input.at(m).size(); p++ ){
      ...
      if ( Input.at(m).at(p) != 0. ){
        ...
        pT = (double)(*std::max_element(width_pt.at(m).at(p).begin(),width_pt.at(m).at(p).end()));
